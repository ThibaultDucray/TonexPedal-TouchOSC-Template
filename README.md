...
Also, on MIDI channel 5: load presets 1 to 20. To use: send MIDI message to TouchOSC on channel 5: PC <preset_number>, then send CC 1 to load the content of the preset (there will be an option for automatic loading in a next release). You can force the re-sending of the complete MIDI parameters of the preset with CC 0.
